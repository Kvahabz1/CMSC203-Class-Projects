...
public class Person {
	...
	private final int DEFAULT_SIZE=  5;  // default size of the  citiesLivedIn;
	...
	{
		if (numOfCities < DEFAULT_SIZE  )  // check if the array is not full
		{
			citiesLivedIn[numOfCities] = city;
			numOfCities++;
		}
		//if the array is full do nothing
	}
	 ...
	 */
	public String listOfcitiesLivedIn()
	{
		String temp = "";
